$(document).ready(function() {
    ...
    $("#paragraph_box_3" ).droppable({
      	drop: function( event, ui ) {
      		...
      		script.className='webxray';
      		document.body.appendChild(script);
      		$("#crime_1_text").replaceWith("<span id='crime_2_text' class='instructions_text_body'>We are not done solving crime for the day Watson. This image of a puppy might look cute and adorable to you. But after my experience with a certain hound in Baskerville I find dogs of any kind intolerable. Replace this puppy by a cat and quick!</span>");
    ...
    $("#paragraph_box_2" ).droppable({
      	drop: function( event, ui ) {
      		...
      		script.className='webxray';
      		document.body.appendChild(script);
            $("#crime_2_text").replaceWith("<span id='crime_3_text' class='instructions_text_body'>Well Watson this is our last stop for the day. This is Brown University. The text you see is the creed of the students. It's nice, but I think they have their priorities a little mixed up, don't you?</span>");
